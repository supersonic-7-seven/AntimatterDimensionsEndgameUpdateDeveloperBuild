...
export const STUDY_TREE_LAYOUT_TYPE = {
  ...
  get current() {
    const alt62 = Perk.bypassEC5Lock.canBeApplied;
    const alt181 = Perk.bypassEC1Lock.canBeApplied && Perk.bypassEC2Lock.canBeApplied && Perk.bypassEC3Lock.canBeApplied;
