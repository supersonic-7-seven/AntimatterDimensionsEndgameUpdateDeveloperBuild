export const Penteracts = {
  ...
  get canBuyPenteract() {
    return DualityUpgrade(25).isBought && Currency.eternityPoints.gte(Penteracts.nextCost) && !player.disablePostReality;
  },
...
export const Hexeracts = {
  ...
  get canBuyHexeract() {
    return DualityUpgrade(25).isBought && player.celestials.laitela.hadronizes >= 40 &&
      Currency.darkMatter.gte(Hexeracts.nextCost) && !player.disablePostReality;
  },
...
export const Hepteracts = {
  ...
  get canBuyHepteract() {
    return DualityUpgrade(25).isBought && false &&
      Currency.celestialPoints.gte(Hepteracts.nextCost) && !player.disablePostReality;
  },
...
export const Octeracts = {
  ...
  get canBuyOcteract() {
    return DualityUpgrade(25).isBought && false &&
      DC.D0.gte(Octeracts.nextCost) && !player.disablePostReality;
  },
