...
export const singularityMilestones = {
  ...
  dimensionPow: {
    ...
    effect: () => Math.pow(1 + Math.log10(Currency.singularities.value + 1) / 125, 0.5),
    effectFormat: x => formatPow(x, 2, 3),
    upgradeDirection: LAITELA_UPGRADE_DIRECTION.BOOSTS_MAIN,
  },
  darkFromCelestialMatter: {
    ...
    effect: () => Math.pow(Decimal.log10(Currency.celestialMatter.value.plus(1)) + 1, 5),
    effectFormat: x => formatX(x, 2, 2),
    upgradeDirection: LAITELA_UPGRADE_DIRECTION.BOOSTS_LAITELA,
  },
  rmCap: {
    ...
    effect: () => Math.pow(Math.log10(Math.log10(Currency.singularities.value + 1) + 1) / 10 + 1, 2),
    effectFormat: x => formatPow(x, 2, 3),
    upgradeDirection: LAITELA_UPGRADE_DIRECTION.BOOSTS_MAIN,
  },
  galacticPower: {
    ...
    repeat: 0,
    limit: 1,
    description: "Unlock Galactic Power (NYI)",
    effect: completions => completions,
    effectFormat: x => (x === 1 ? "Unlocked" : "Locked"),
    upgradeDirection: LAITELA_UPGRADE_DIRECTION.BOOSTS_MAIN,
  },
