export const sidebarResources = [
  ...
  },
  {
    ...
    value: () => player.endgame.ethereal.sector,
    formatValue: x => format(x, 2),
    formatClass: "o-sidebar-currency--ethereal",
  },
  {
    ...
    isAvailable: () => player.celestials.laitela.hadronizes.gt(0),
    value: () => player.celestials.laitela.hadronizes,
    formatValue: x => format(x, 2),
    formatClass: "o-sidebar-currency--laitela",
  },
  {
  ...
  },
  {
    ...
    value: () => player.celestials.laitela.hadrons.light,
    formatValue: x => format(x, 2),
    formatClass: "o-sidebar-currency--laitela",
  },
  {
    ...
    value: () => player.celestials.laitela.hadrons.dark,
    formatValue: x => format(x, 2),
    formatClass: "o-sidebar-currency--laitela",
  },
  {
