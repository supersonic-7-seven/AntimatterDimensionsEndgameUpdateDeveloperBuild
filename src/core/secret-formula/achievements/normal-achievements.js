export const normalAchievements = [
  ...
  },
  {
    ...
    checkRequirement: () => AntimatterDimension(1).amount.log10().gte(150),
    checkEvent: GAME_EVENT.ACHIEVEMENT_EVENT_OTHER,
  ...
  },
  {
    ...
    checkRequirement: () => AntimatterDimensions.all.some(x => x.multiplier.log10().gte(31)),
    checkEvent: GAME_EVENT.GAME_TICK_AFTER,
  ...
  },
  {
    ...
    checkRequirement: () => AntimatterDimension(7).amount.log10().gte(12),
    checkEvent: GAME_EVENT.GAME_TICK_AFTER
  },
  {
    id: 47,
  ...
  },
  {
    ...
    checkRequirement: () => Player.bestRunIPPM.log10().gte(8),
    checkEvent: GAME_EVENT.BIG_CRUNCH_AFTER
  },
  {
    id: 63,
  ...
  },
  {
    ...
    checkRequirement: () => gainedInfinityPoints().log10().gte(150),
    checkEvent: GAME_EVENT.BIG_CRUNCH_BEFORE,
  ...
  },
  {
    ...
    checkRequirement: () => gainedInfinityPoints().log10().gte(200) && Time.thisInfinityRealTime.totalSeconds.toNumber() <= 2,
    checkEvent: GAME_EVENT.BIG_CRUNCH_BEFORE,
    get reward() {
  ...
  },
  {
    ...
    checkRequirement: () => gainedInfinityPoints().log10().gte(250) && Time.thisInfinityRealTime.totalSeconds.toNumber() <= 20,
    checkEvent: GAME_EVENT.BIG_CRUNCH_BEFORE,
    get reward() {
      return `All Antimatter Dimensions are significantly stronger in the
  ...
  },
  {
    ...
    checkRequirement: () => gainedInfinityPoints().log10().gte(300),
    checkEvent: GAME_EVENT.BIG_CRUNCH_BEFORE,
    get reward() { return `Additional ${formatX(4)} multiplier to Infinity Points.`; },
    effect: 4
  },
  ...
  },
  {
    ...
    checkRequirement: () => Sacrifice.totalBoost.log10().gte(9000),
    checkEvent: GAME_EVENT.SACRIFICE_RESET_AFTER,
  ...
  },
  {
    ...
    checkRequirement: () => Replicanti.amount.log10().gte(15000),
    checkEvent: GAME_EVENT.GAME_TICK_AFTER,
    get reward() {
