...
TimeStudy.allConnections = (function() {
  ...
  const connections = [
    ...
    [TS(42), TS(62), () => (!Perk.bypassEC5Lock.canBeApplied)],

    [TS(51), TS(61)],
    [EC(5), TS(62), () => (Perk.bypassEC5Lock.canBeApplied)],
    ...
    [TS(171), TS(181),
      () => (!Perk.bypassEC1Lock.canBeApplied || !Perk.bypassEC2Lock.canBeApplied || !Perk.bypassEC3Lock.canBeApplied)],

    [EC(1), TS(181), () => (Perk.bypassEC1Lock.canBeApplied)],
    [EC(2), TS(181), () => (Perk.bypassEC2Lock.canBeApplied)],
    [EC(3), TS(181), () => (Perk.bypassEC3Lock.canBeApplied)],
