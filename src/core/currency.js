...
export class Currency {
  ...
  subtract(amount) {
    ...
    if (new Decimal(amount).gte(this.value) && this.value instanceof Decimal) this.value = Decimal.floor(this.value.div(1e15));
    if (new Decimal(amount).gte(this.value) && typeof this.value === "number") this.value = Math.floor(this.value / 1e15);
