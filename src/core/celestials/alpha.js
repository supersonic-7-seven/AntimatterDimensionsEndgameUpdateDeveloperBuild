...
export const Alpha = {
  ...
  initializeRun() {
    ...
    if (alphaRecords.records.totalEndgameAntimatter.gt(DC.E1)) {
      ...
      player.auto.antimatterDims[0].isUnlocked = alphaRecords.auto.antimatterDims[0].isUnlocked;
      player.auto.antimatterDims[0].cost = alphaRecords.auto.antimatterDims[0].cost;
      player.auto.antimatterDims[0].interval = alphaRecords.auto.antimatterDims[0].interval;
      player.auto.antimatterDims[0].bulk = alphaRecords.auto.antimatterDims[0].bulk;
      player.auto.antimatterDims[0].mode = alphaRecords.auto.antimatterDims[0].mode;
      player.auto.antimatterDims[0].isActive = alphaRecords.auto.antimatterDims[0].isActive;
      player.auto.antimatterDims[0].lastTick = alphaRecords.auto.antimatterDims[0].lastTick;
      player.auto.antimatterDims[0].isBought = alphaRecords.auto.antimatterDims[0].isBought;
      player.auto.antimatterDims[1].isUnlocked = alphaRecords.auto.antimatterDims[1].isUnlocked;
      player.auto.antimatterDims[1].cost = alphaRecords.auto.antimatterDims[1].cost;
      player.auto.antimatterDims[1].interval = alphaRecords.auto.antimatterDims[1].interval;
      player.auto.antimatterDims[1].bulk = alphaRecords.auto.antimatterDims[1].bulk;
      player.auto.antimatterDims[1].mode = alphaRecords.auto.antimatterDims[1].mode;
      player.auto.antimatterDims[1].isActive = alphaRecords.auto.antimatterDims[1].isActive;
      player.auto.antimatterDims[1].lastTick = alphaRecords.auto.antimatterDims[1].lastTick;
      player.auto.antimatterDims[1].isBought = alphaRecords.auto.antimatterDims[1].isBought;
      player.auto.antimatterDims[2].isUnlocked = alphaRecords.auto.antimatterDims[2].isUnlocked;
      player.auto.antimatterDims[2].cost = alphaRecords.auto.antimatterDims[2].cost;
      player.auto.antimatterDims[2].interval = alphaRecords.auto.antimatterDims[2].interval;
      player.auto.antimatterDims[2].bulk = alphaRecords.auto.antimatterDims[2].bulk;
      player.auto.antimatterDims[2].mode = alphaRecords.auto.antimatterDims[2].mode;
      player.auto.antimatterDims[2].isActive = alphaRecords.auto.antimatterDims[2].isActive;
      player.auto.antimatterDims[2].lastTick = alphaRecords.auto.antimatterDims[2].lastTick;
      player.auto.antimatterDims[2].isBought = alphaRecords.auto.antimatterDims[2].isBought;
      player.auto.antimatterDims[3].isUnlocked = alphaRecords.auto.antimatterDims[3].isUnlocked;
      player.auto.antimatterDims[3].cost = alphaRecords.auto.antimatterDims[3].cost;
      player.auto.antimatterDims[3].interval = alphaRecords.auto.antimatterDims[3].interval;
      player.auto.antimatterDims[3].bulk = alphaRecords.auto.antimatterDims[3].bulk;
      player.auto.antimatterDims[3].mode = alphaRecords.auto.antimatterDims[3].mode;
      player.auto.antimatterDims[3].isActive = alphaRecords.auto.antimatterDims[3].isActive;
      player.auto.antimatterDims[3].lastTick = alphaRecords.auto.antimatterDims[3].lastTick;
      player.auto.antimatterDims[3].isBought = alphaRecords.auto.antimatterDims[3].isBought;
      player.auto.antimatterDims[4].isUnlocked = alphaRecords.auto.antimatterDims[4].isUnlocked;
      player.auto.antimatterDims[4].cost = alphaRecords.auto.antimatterDims[4].cost;
      player.auto.antimatterDims[4].interval = alphaRecords.auto.antimatterDims[4].interval;
      player.auto.antimatterDims[4].bulk = alphaRecords.auto.antimatterDims[4].bulk;
      player.auto.antimatterDims[4].mode = alphaRecords.auto.antimatterDims[4].mode;
      player.auto.antimatterDims[4].isActive = alphaRecords.auto.antimatterDims[4].isActive;
      player.auto.antimatterDims[4].lastTick = alphaRecords.auto.antimatterDims[4].lastTick;
      player.auto.antimatterDims[4].isBought = alphaRecords.auto.antimatterDims[4].isBought;
      player.auto.antimatterDims[5].isUnlocked = alphaRecords.auto.antimatterDims[5].isUnlocked;
      player.auto.antimatterDims[5].cost = alphaRecords.auto.antimatterDims[5].cost;
      player.auto.antimatterDims[5].interval = alphaRecords.auto.antimatterDims[5].interval;
      player.auto.antimatterDims[5].bulk = alphaRecords.auto.antimatterDims[5].bulk;
      player.auto.antimatterDims[5].mode = alphaRecords.auto.antimatterDims[5].mode;
      player.auto.antimatterDims[5].isActive = alphaRecords.auto.antimatterDims[5].isActive;
      player.auto.antimatterDims[5].lastTick = alphaRecords.auto.antimatterDims[5].lastTick;
      player.auto.antimatterDims[5].isBought = alphaRecords.auto.antimatterDims[5].isBought;
      player.auto.antimatterDims[6].isUnlocked = alphaRecords.auto.antimatterDims[6].isUnlocked;
      player.auto.antimatterDims[6].cost = alphaRecords.auto.antimatterDims[6].cost;
      player.auto.antimatterDims[6].interval = alphaRecords.auto.antimatterDims[6].interval;
      player.auto.antimatterDims[6].bulk = alphaRecords.auto.antimatterDims[6].bulk;
      player.auto.antimatterDims[6].mode = alphaRecords.auto.antimatterDims[6].mode;
      player.auto.antimatterDims[6].isActive = alphaRecords.auto.antimatterDims[6].isActive;
      player.auto.antimatterDims[6].lastTick = alphaRecords.auto.antimatterDims[6].lastTick;
      player.auto.antimatterDims[6].isBought = alphaRecords.auto.antimatterDims[6].isBought;
      player.auto.antimatterDims[7].isUnlocked = alphaRecords.auto.antimatterDims[7].isUnlocked;
      player.auto.antimatterDims[7].cost = alphaRecords.auto.antimatterDims[7].cost;
      player.auto.antimatterDims[7].interval = alphaRecords.auto.antimatterDims[7].interval;
      player.auto.antimatterDims[7].bulk = alphaRecords.auto.antimatterDims[7].bulk;
      player.auto.antimatterDims[7].mode = alphaRecords.auto.antimatterDims[7].mode;
      player.auto.antimatterDims[7].isActive = alphaRecords.auto.antimatterDims[7].isActive;
      player.auto.antimatterDims[7].lastTick = alphaRecords.auto.antimatterDims[7].lastTick;
      player.auto.antimatterDims[7].isBought = alphaRecords.auto.antimatterDims[7].isBought;
      player.auto.antimatterDims.isActive = alphaRecords.auto.antimatterDims.isActive;
      player.auto.infinityDims[0].isActive = alphaRecords.auto.infinityDims[0].isActive;
      player.auto.infinityDims[0].lastTick = alphaRecords.auto.infinityDims[0].lastTick;
      player.auto.infinityDims[1].isActive = alphaRecords.auto.infinityDims[1].isActive;
      player.auto.infinityDims[1].lastTick = alphaRecords.auto.infinityDims[1].lastTick;
      player.auto.infinityDims[2].isActive = alphaRecords.auto.infinityDims[2].isActive;
      player.auto.infinityDims[2].lastTick = alphaRecords.auto.infinityDims[2].lastTick;
      player.auto.infinityDims[3].isActive = alphaRecords.auto.infinityDims[3].isActive;
      player.auto.infinityDims[3].lastTick = alphaRecords.auto.infinityDims[3].lastTick;
      player.auto.infinityDims[4].isActive = alphaRecords.auto.infinityDims[4].isActive;
      player.auto.infinityDims[4].lastTick = alphaRecords.auto.infinityDims[4].lastTick;
      player.auto.infinityDims[5].isActive = alphaRecords.auto.infinityDims[5].isActive;
      player.auto.infinityDims[5].lastTick = alphaRecords.auto.infinityDims[5].lastTick;
      player.auto.infinityDims[6].isActive = alphaRecords.auto.infinityDims[6].isActive;
      player.auto.infinityDims[6].lastTick = alphaRecords.auto.infinityDims[6].lastTick;
      player.auto.infinityDims[7].isActive = alphaRecords.auto.infinityDims[7].isActive;
      player.auto.infinityDims[7].lastTick = alphaRecords.auto.infinityDims[7].lastTick;
      ...
      player.auto.replicantiUpgrades[0].isActive = alphaRecords.auto.replicantiUpgrades[0].isActive;
      player.auto.replicantiUpgrades[0].lastTick = alphaRecords.auto.replicantiUpgrades[0].lastTick;
      player.auto.replicantiUpgrades[1].isActive = alphaRecords.auto.replicantiUpgrades[1].isActive;
      player.auto.replicantiUpgrades[1].lastTick = alphaRecords.auto.replicantiUpgrades[1].lastTick;
      player.auto.replicantiUpgrades[2].isActive = alphaRecords.auto.replicantiUpgrades[2].isActive;
      player.auto.replicantiUpgrades[2].lastTick = alphaRecords.auto.replicantiUpgrades[2].lastTick;
  ...
  escapeTheMatrix() {
    ...
    alphaRecords.auto.antimatterDims[0].isUnlocked = player.auto.antimatterDims[0].isUnlocked;
    alphaRecords.auto.antimatterDims[0].cost = player.auto.antimatterDims[0].cost;
    alphaRecords.auto.antimatterDims[0].interval = player.auto.antimatterDims[0].interval;
    alphaRecords.auto.antimatterDims[0].bulk = player.auto.antimatterDims[0].bulk;
    alphaRecords.auto.antimatterDims[0].mode = player.auto.antimatterDims[0].mode;
    alphaRecords.auto.antimatterDims[0].isActive = player.auto.antimatterDims[0].isActive;
    alphaRecords.auto.antimatterDims[0].lastTick = player.auto.antimatterDims[0].lastTick;
    alphaRecords.auto.antimatterDims[0].isBought = player.auto.antimatterDims[0].isBought;
    alphaRecords.auto.antimatterDims[1].isUnlocked = player.auto.antimatterDims[1].isUnlocked;
    alphaRecords.auto.antimatterDims[1].cost = player.auto.antimatterDims[1].cost;
    alphaRecords.auto.antimatterDims[1].interval = player.auto.antimatterDims[1].interval;
    alphaRecords.auto.antimatterDims[1].bulk = player.auto.antimatterDims[1].bulk;
    alphaRecords.auto.antimatterDims[1].mode = player.auto.antimatterDims[1].mode;
    alphaRecords.auto.antimatterDims[1].isActive = player.auto.antimatterDims[1].isActive;
    alphaRecords.auto.antimatterDims[1].lastTick = player.auto.antimatterDims[1].lastTick;
    alphaRecords.auto.antimatterDims[1].isBought = player.auto.antimatterDims[1].isBought;
    alphaRecords.auto.antimatterDims[2].isUnlocked = player.auto.antimatterDims[2].isUnlocked;
    alphaRecords.auto.antimatterDims[2].cost = player.auto.antimatterDims[2].cost;
    alphaRecords.auto.antimatterDims[2].interval = player.auto.antimatterDims[2].interval;
    alphaRecords.auto.antimatterDims[2].bulk = player.auto.antimatterDims[2].bulk;
    alphaRecords.auto.antimatterDims[2].mode = player.auto.antimatterDims[2].mode;
    alphaRecords.auto.antimatterDims[2].isActive = player.auto.antimatterDims[2].isActive;
    alphaRecords.auto.antimatterDims[2].lastTick = player.auto.antimatterDims[2].lastTick;
    alphaRecords.auto.antimatterDims[2].isBought = player.auto.antimatterDims[2].isBought;
    alphaRecords.auto.antimatterDims[3].isUnlocked = player.auto.antimatterDims[3].isUnlocked;
    alphaRecords.auto.antimatterDims[3].cost = player.auto.antimatterDims[3].cost;
    alphaRecords.auto.antimatterDims[3].interval = player.auto.antimatterDims[3].interval;
    alphaRecords.auto.antimatterDims[3].bulk = player.auto.antimatterDims[3].bulk;
    alphaRecords.auto.antimatterDims[3].mode = player.auto.antimatterDims[3].mode;
    alphaRecords.auto.antimatterDims[3].isActive = player.auto.antimatterDims[3].isActive;
    alphaRecords.auto.antimatterDims[3].lastTick = player.auto.antimatterDims[3].lastTick;
    alphaRecords.auto.antimatterDims[3].isBought = player.auto.antimatterDims[3].isBought;
    alphaRecords.auto.antimatterDims[4].isUnlocked = player.auto.antimatterDims[4].isUnlocked;
    alphaRecords.auto.antimatterDims[4].cost = player.auto.antimatterDims[4].cost;
    alphaRecords.auto.antimatterDims[4].interval = player.auto.antimatterDims[4].interval;
    alphaRecords.auto.antimatterDims[4].bulk = player.auto.antimatterDims[4].bulk;
    alphaRecords.auto.antimatterDims[4].mode = player.auto.antimatterDims[4].mode;
    alphaRecords.auto.antimatterDims[4].isActive = player.auto.antimatterDims[4].isActive;
    alphaRecords.auto.antimatterDims[4].lastTick = player.auto.antimatterDims[4].lastTick;
    alphaRecords.auto.antimatterDims[4].isBought = player.auto.antimatterDims[4].isBought;
    alphaRecords.auto.antimatterDims[5].isUnlocked = player.auto.antimatterDims[5].isUnlocked;
    alphaRecords.auto.antimatterDims[5].cost = player.auto.antimatterDims[5].cost;
    alphaRecords.auto.antimatterDims[5].interval = player.auto.antimatterDims[5].interval;
    alphaRecords.auto.antimatterDims[5].bulk = player.auto.antimatterDims[5].bulk;
    alphaRecords.auto.antimatterDims[5].mode = player.auto.antimatterDims[5].mode;
    alphaRecords.auto.antimatterDims[5].isActive = player.auto.antimatterDims[5].isActive;
    alphaRecords.auto.antimatterDims[5].lastTick = player.auto.antimatterDims[5].lastTick;
    alphaRecords.auto.antimatterDims[5].isBought = player.auto.antimatterDims[5].isBought;
    alphaRecords.auto.antimatterDims[6].isUnlocked = player.auto.antimatterDims[6].isUnlocked;
    alphaRecords.auto.antimatterDims[6].cost = player.auto.antimatterDims[6].cost;
    alphaRecords.auto.antimatterDims[6].interval = player.auto.antimatterDims[6].interval;
    alphaRecords.auto.antimatterDims[6].bulk = player.auto.antimatterDims[6].bulk;
    alphaRecords.auto.antimatterDims[6].mode = player.auto.antimatterDims[6].mode;
    alphaRecords.auto.antimatterDims[6].isActive = player.auto.antimatterDims[6].isActive;
    alphaRecords.auto.antimatterDims[6].lastTick = player.auto.antimatterDims[6].lastTick;
    alphaRecords.auto.antimatterDims[6].isBought = player.auto.antimatterDims[6].isBought;
    alphaRecords.auto.antimatterDims[7].isUnlocked = player.auto.antimatterDims[7].isUnlocked;
    alphaRecords.auto.antimatterDims[7].cost = player.auto.antimatterDims[7].cost;
    alphaRecords.auto.antimatterDims[7].interval = player.auto.antimatterDims[7].interval;
    alphaRecords.auto.antimatterDims[7].bulk = player.auto.antimatterDims[7].bulk;
    alphaRecords.auto.antimatterDims[7].mode = player.auto.antimatterDims[7].mode;
    alphaRecords.auto.antimatterDims[7].isActive = player.auto.antimatterDims[7].isActive;
    alphaRecords.auto.antimatterDims[7].lastTick = player.auto.antimatterDims[7].lastTick;
    alphaRecords.auto.antimatterDims[7].isBought = player.auto.antimatterDims[7].isBought;
    alphaRecords.auto.antimatterDims.isActive = player.auto.antimatterDims.isActive;
    alphaRecords.auto.infinityDims[0].isActive = player.auto.infinityDims[0].isActive;
    alphaRecords.auto.infinityDims[0].lastTick = player.auto.infinityDims[0].lastTick;
    alphaRecords.auto.infinityDims[1].isActive = player.auto.infinityDims[1].isActive;
    alphaRecords.auto.infinityDims[1].lastTick = player.auto.infinityDims[1].lastTick;
    alphaRecords.auto.infinityDims[2].isActive = player.auto.infinityDims[2].isActive;
    alphaRecords.auto.infinityDims[2].lastTick = player.auto.infinityDims[2].lastTick;
    alphaRecords.auto.infinityDims[3].isActive = player.auto.infinityDims[3].isActive;
    alphaRecords.auto.infinityDims[3].lastTick = player.auto.infinityDims[3].lastTick;
    alphaRecords.auto.infinityDims[4].isActive = player.auto.infinityDims[4].isActive;
    alphaRecords.auto.infinityDims[4].lastTick = player.auto.infinityDims[4].lastTick;
    alphaRecords.auto.infinityDims[5].isActive = player.auto.infinityDims[5].isActive;
    alphaRecords.auto.infinityDims[5].lastTick = player.auto.infinityDims[5].lastTick;
    alphaRecords.auto.infinityDims[6].isActive = player.auto.infinityDims[6].isActive;
    alphaRecords.auto.infinityDims[6].lastTick = player.auto.infinityDims[6].lastTick;
    alphaRecords.auto.infinityDims[7].isActive = player.auto.infinityDims[7].isActive;
    alphaRecords.auto.infinityDims[7].lastTick = player.auto.infinityDims[7].lastTick;
    ...
    alphaRecords.auto.replicantiUpgrades[0].isActive = player.auto.replicantiUpgrades[0].isActive;
    alphaRecords.auto.replicantiUpgrades[0].lastTick = player.auto.replicantiUpgrades[0].lastTick;
    alphaRecords.auto.replicantiUpgrades[1].isActive = player.auto.replicantiUpgrades[1].isActive;
    alphaRecords.auto.replicantiUpgrades[1].lastTick = player.auto.replicantiUpgrades[1].lastTick;
    alphaRecords.auto.replicantiUpgrades[2].isActive = player.auto.replicantiUpgrades[2].isActive;
    alphaRecords.auto.replicantiUpgrades[2].lastTick = player.auto.replicantiUpgrades[2].lastTick;
